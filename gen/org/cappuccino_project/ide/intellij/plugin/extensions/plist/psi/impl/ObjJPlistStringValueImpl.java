...
public class ObjJPlistStringValueImpl extends ASTWrapperPsiElement implements ObjJPlistStringValue {

  public ObjJPlistStringValueImpl(ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public PsiElement getStringTagLiteral() {
    return findNotNullChildByType(ObjJPlist_STRING_TAG_LITERAL);
  }
