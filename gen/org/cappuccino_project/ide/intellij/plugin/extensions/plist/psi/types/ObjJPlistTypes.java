...
public interface ObjJPlistTypes {
  ...
  IElementType ObjJPlist_DATA_LITERAL = new ObjJPlistTokenType("DATA_LITERAL");
  ...
  IElementType ObjJPlist_STRING_TAG_LITERAL = new ObjJPlistTokenType("STRING_TAG_LITERAL");
