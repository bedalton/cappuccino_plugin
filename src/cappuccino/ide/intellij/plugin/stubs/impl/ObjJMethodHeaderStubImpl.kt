...
class ObjJMethodHeaderStubImpl(parent: StubElement<*>?, className: String?, override val isStatic: Boolean, override val selectorStrings: List<String>, override val parameterTypes: List<String>, override val explicitReturnType: String, override val isRequired: Boolean, private val shouldResolve: Boolean, override val ignored:Boolean, override val selectorStructs: List<ObjJSelectorStruct>) : ObjJStubBaseImpl<ObjJMethodHeaderImpl>(parent, ObjJStubTypes.METHOD_HEADER), ObjJMethodHeaderStub {
