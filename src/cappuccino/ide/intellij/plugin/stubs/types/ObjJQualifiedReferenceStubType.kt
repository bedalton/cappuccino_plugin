...
fun ObjJQualifiedReference.toStubParts() : List<ObjJQualifiedReferenceComponentPart> {
    return qualifiedNameParts.map { part ->
        when (part) {
            is ObjJArrayIndexSelector -> ObjJQualifiedReferenceComponentPart(null, ObjJQualifiedReferenceComponentPartType.ARRAY_COMPONENT)
            ...
            is ObjJParenEnclosedExpr -> ObjJQualifiedReferenceComponentPart(null, ObjJQualifiedReferenceComponentPartType.PAREN_ENCLOSED_EXPR)
