...
class ObjJBraceMatcher : PairedBraceMatcher {
    ...
    override fun isPairedBracesAllowedBeforeType(lbraceType: IElementType, contextType: IElementType?): Boolean {
        return if (lbraceType === ObjJTypes.ObjJ_OPEN_BRACKET) {
            isPairedBracketAllowedBeforeType(contextType)
        } else isAllowed(NOT_BEFORE, contextType)
    }
    ...
    companion object {
        private val PAIRS = arrayOf(BracePair(ObjJ_OPEN_PAREN, ObjJ_CLOSE_PAREN, false), BracePair(ObjJ_OPEN_BRACKET, ObjJ_CLOSE_BRACKET, false), BracePair(ObjJ_OPEN_BRACE, ObjJ_CLOSE_BRACE, false), BracePair(ObjJ_AT_OPENBRACKET, ObjJ_CLOSE_BRACKET, false), BracePair(ObjJ_AT_OPEN_BRACE, ObjJ_CLOSE_BRACE, false), BracePair(ObjJ_DOUBLE_QUO, ObjJ_DOUBLE_QUO, false), BracePair(ObjJ_SINGLE_QUO, ObjJ_SINGLE_QUO, false), BracePair(ObjJ_BLOCK_COMMENT_START, ObjJ_BLOCK_COMMENT_END, false))
