...
private val TAN = fn (
        name = "TAN",
        parameters = listOf (p (name = "x", type = "number", "A numeric expression that contains an angle measured in radians.")),
...
private fun createGlobalJsFunctions(): List<GlobalJsFunction> {
    val globalJsFunctions = mutableListOf<GlobalJsFunction>(
            ...
            fn (name = "class_addIvars", parameters = listOf(p("aClass", "Class"), p("ivars", "objj_ivar[]"))),
            fn (name = "class_copyIvarList", parameters = listOf(p("aClass", "Class")), returns = "objj_ivar[]"),
            fn (name = "class_addMethod", parameters = )
...
val globalJsnames = globalJsFunctions.names()
...
fun List<GlobalJSClassFunction>.names(): List<String> {
