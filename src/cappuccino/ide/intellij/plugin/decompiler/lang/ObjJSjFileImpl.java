...
public class ObjJSjFileImpl extends PsiFile implements PsiCompiledFile, PsiFileWithStubSupport {
    private static final Logger LOGGER = Logger.getInstance(ObjJSjFileImpl.class);
    ...
    @NotNull
    private final ObjJSjFileViewProvider fileViewProvider;
    ...
    public ObjJSjFileImpl(@NotNull ObjJSjFileViewProvider fileViewProvider) {
        this(fileViewProvider, false);
    }

    private ObjJSjFileImpl(@NotNull ObjJSjFileViewProvider fileViewProvider, boolean isForDecompiling) {
     ...
     */
    @Override
    public PsiElement setName(@NonNls
    ...
    public StubTree getStubTree() {
        ...
        if (newStubTree == null) {
            ...
            newStubTree = new StubTree(new ObjJSjFileStubImpl());
        }
     ...
     * and not yet committed ({@link PsiDocumentManager#commitDocument(com.intellij.openapi.editor.Document)} (Document)}).
    ...
    @NotNull
    @Override
    public ObjJSjFileType getFileType() {
    ...
    public void setMirror(@NotNull TreeElement element) {
        ...
        if (!(mirrorElement instanceof ElixirFile)) {
            throw new RuntimeException("Unexpected mirror file: " + mirrorElement);
        }
