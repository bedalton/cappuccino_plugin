...
object ObjJIcons {
    ...
    val ACCESSOR_ICON = IconLoader.getIcon("/icons/accessor-icon.png")
    val SELECTOR_ICON = IconLoader.getIcon("/icons/selector-icon.png")
    val VARIABLE_ICON = IconLoader.getIcon("/icons/variable-icon.png")
}