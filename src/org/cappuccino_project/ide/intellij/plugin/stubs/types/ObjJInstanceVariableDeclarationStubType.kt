...
class ObjJInstanceVariableDeclarationStubType internal constructor(
        debugName: String) : ObjJStubElementType<ObjJInstanceVariableDeclarationStub, ObjJInstanceVariableDeclarationImpl>(debugName, ObjJInstanceVariableDeclarationImpl::class.java, ObjJInstanceVariableDeclarationStub::class.java) {
