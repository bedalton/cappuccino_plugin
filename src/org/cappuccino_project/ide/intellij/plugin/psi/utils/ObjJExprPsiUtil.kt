...
object ObjJExprPsiUtil {
    ...
    private fun isLeftExpressionAssignmentToVariable(leftExpr: ObjJLeftExpr?, variableNameString: String): Boolean {
        ...
        if (leftExpr.variableAssignmentLogical != null) {
            ...
            return assignment.variableName != null && assignment.variableName == variableNameString
        }
    ...
    private fun allInternalExpressions(out: List<ObjJExpr>, leftExpr: ObjJLeftExpr?) {
        if (leftExpr == null) {
            return
        }
    ...
    private fun allInternalExpressions(out: List<ObjJExpr>, exprRight: ObjJRightExpr?) {
        if (exprRight == null) {
            return
        }
    ...
    private fun getAllInternalMethodCallExpressions(out: MutableList<ObjJMethodCall>, left: ObjJLeftExpr?) {
        ...
        if (left.qualifiedReference != null && left.qualifiedReference!!.methodCall != null) {
