...
{
    var didSet = [_textField setThemeState:aState];
    return [super setThemeState:aState] && didSet;
}
...
{
    var didUnset = [_textField unsetThemeState:aState];
    return [super unsetThemeState:aState] && didUnset;
}
