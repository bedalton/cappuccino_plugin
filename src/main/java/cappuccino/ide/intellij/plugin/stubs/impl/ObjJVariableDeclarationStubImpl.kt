...
class ObjJVariableDeclarationStubImpl(parent: StubElement<*>, override val qualifiedNamesList: List<QualifiedReferenceStubComponents>, override val hasVariableKeyword: Boolean) : ObjJStubBaseImpl<ObjJVariableDeclarationImpl>(parent, ObjJStubTypes.VARIABLE_DECLARATION), ObjJVariableDeclarationStub