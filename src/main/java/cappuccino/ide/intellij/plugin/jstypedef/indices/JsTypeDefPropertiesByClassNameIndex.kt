...
class JsTypeDefPropertiesByClassNameIndex private constructor() : JsTypeDefStringStubIndexBase<JsTypeDefProperty>() {
    ...
    companion object {
        ...
        val instance = JsTypeDefPropertiesByClassNameIndex()

        private val KEY = IndexKeyUtil.createIndexKey(JsTypeDefPropertiesByClassNameIndex::class.java)
