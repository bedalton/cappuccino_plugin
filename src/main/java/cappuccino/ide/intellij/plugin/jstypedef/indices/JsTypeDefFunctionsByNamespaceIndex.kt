...
class JsTypeDefFunctionsByNamespaceIndex private constructor() : JsTypeDefStringStubIndexBase<JsTypeDefFunction>() {
    ...
    companion object {
        ...
        val instance = JsTypeDefFunctionsByNamespaceIndex()

        private val KEY = IndexKeyUtil.createIndexKey(JsTypeDefFunctionsByNamespaceIndex::class.java)
