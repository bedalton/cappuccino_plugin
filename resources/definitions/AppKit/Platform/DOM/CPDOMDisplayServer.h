...
#define CPDOMDisplayServerAriaIndex(anElement, index) \
	anElement.setAttribute("tabindex", index);

#define CPDOMDisplayServerAriaLabel(anElement, label) \
	anElement.setAttribute("aria-label", label);

#define CPDOMDisplayServerAriaRole(anElement, role) \
	anElement.setAttribute("role", role);
